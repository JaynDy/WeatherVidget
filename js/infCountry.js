export const countryCodesToNames = {
  ...
  AIDJ: "French Afars and Issas",
  FQHH: "French Southern and Antarctic Territories (now split between AQ and TF)",
  DDDE: "German Democratic Republic",
  DE: "Germany, Federal Republic of",
  GEHH: "Gilbert & Ellice Islands (now split into Kiribati and Tuvalu)",
  JTUM: "Johnston Island",
  MIUM: "Midway Islands",
  AN: "Netherlands Antilles",
  NTHH: "Neutral Zone (formerly between Saudi Arabia & Iraq)",
  NHVU: "New Hebrides",
  PCHH: "Pacific Islands (trust territory) (divided into FM, MH, MP, and PW)",
  PA: "Panama, Republic of",
  PZPA: "Panama Canal Zone",
  RO: "Romania, Socialist Republic of",
  KN: "St. Kitts-Nevis-Anguilla (now St. Kitts and Nevis and Anguilla)",
  SKIN: "Sikkim",
  RHZW: "Southern Rhodesia",
  EH: "Spanish Sahara (now Western Sahara)",
  PUUM: "US Miscellaneous Pacific Islands",
  SUHH: "USSR, Union of Soviet Socialist Republics",
  HVBF: "Upper Volta, Republic of",
  VA: "Vatican City State (Holy See)",
  VDVN: "Viet-Nam, Democratic Republic of",
  WKUM: "Wake Island",
  YDYE: "Yemen, Democratic, People's Democratic Republic of",
  YE: "Yemen, Yemen Arab Republic",
  YU: "Yugoslavia, Socialist Federal Republic of",
  YUCS: "Yugoslavia, Federal Republic of",
  ZRCD: "Zaire, Republic of",
};
